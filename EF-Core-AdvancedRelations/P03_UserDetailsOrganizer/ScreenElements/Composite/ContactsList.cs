namespace P03_UserDetailsOrganizer.ScreenElements.Composite
{
    using System;
    using Utility;
    ...
    public class ContactsList : ScreenElement
    {
        ...
        public void SetDetails(string[] details)
        {
            ...
            this.details.AddItem(0, 0, content: "User:");
            this.details.AddItem(12, 0, content: "First name:");
            this.details.AddItem(24, 0, content: details[0]);
            this.details.AddItem(0, 2, content: "Last name:");
            this.details.AddItem(12, 2, content: details[1]);
            this.details.AddItem(0, 4, content: "PaymentMethods:");
            this.details.AddItem(12, 4, content: details[3]);
